...
define(['BuildingTool', 'BulldozerTool', 'ParkTool', 'RailTool', 'RoadTool', 'QueryTool', 'Tile', 'WireTool'],
  ...
  function gameTools(map) {
    return {
      ...
      coal: new BuildingTool(0, Tile.POWERPLANT, map, 4, false),
      ...
      industrial: new BuildingTool(118000000000, Tile.INDCLR, map, 3, false),
      nuclear: new BuildingTool(118000000000, Tile.NUCLEAR, map, 4, true),
      park: new ParkTool(map),
      police: new BuildingTool(118000000000, Tile.POLICESTATION, map, 3, false),
      port: new BuildingTool(4500000000, Tile.PORT, map, 4, false),
      rail: new RailTool(map),
      residential: new BuildingTool(36150000000, Tile.FREEZ, map, 3, false),
      road: new RoadTool(map),
      query: new QueryTool(map),
      stadium: new BuildingTool(150000000, Tile.STADIUM, map, 4, false),
